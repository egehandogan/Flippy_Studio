        ...
        {isConnecting ? (
          <div className="py-12 flex flex-col items-center justify-center space-y-4">
            <div className="relative">
              <div className="w-16 h-16 border-4 border-flippy-blue/20 border-t-flippy-blue rounded-full animate-spin"></div>
              <GithubIcon size={24} className="absolute inset-0 m-auto text-white/40" />
            </div>
            <div className="text-center">
              <div className="text-sm font-bold text-white">Bridging to GitHub...</div>
              <div className="text-[11px] text-white/40 mt-1">Syncing repo tree patterns</div>
            </div>
          </div>
        ) : (
          <>
